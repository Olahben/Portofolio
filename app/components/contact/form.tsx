        ...
        <form className='justify-start flex gap-y-2 flex-col'>
            ...
            <div>
                <button className="rounded-full  bg-btn-color text-white h-14 w-32 text-center
                 font-medium justify-center">Send <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 inline">
